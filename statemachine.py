...
class GameState(object):
    ...
    def save_game(self):
        if 'img1' in player_stats:
            del player_stats['img1']
        if 'img2' in player_stats:
            del player_stats['img2']
        if 'img3' in player_stats:
            del player_stats['img3']
    ...
    def load_game(self):
        ...
        player_stats = self.persist['player_stats']
        print(self.persist)
